...
import { Superhero } from '../../api/superheroes/entities/superhero.entity';

export default class CreateSuperheroes implements Seeder {
  public async run(factory: Factory, dataSource: DataSource): Promise<any> {
    const repository = dataSource.getRepository(Superhero);
    ...
    await repository
      ...
      .values([
        ...
        { id: 63, name: 'Batgirl' },
        { id: 64, name: 'Batgirl' },
        { id: 65, name: 'Batgirl III' },
        { id: 66, name: 'Batgirl IV' },
        { id: 67, name: 'Batgirl V' },
        ...
        { id: 85, name: 'Billy Kincaid' },
        { id: 86, name: 'Binary' },
        { id: 87, name: 'Bionic Woman' },
        { id: 88, name: 'Bird-Brain' },
        { id: 89, name: 'Bird-Man' },
        { id: 90, name: 'Bird-Man II' },
        { id: 91, name: 'Birdman' },
        { id: 92, name: 'Bishop' },
        { id: 93, name: 'Bizarro' },
        { id: 94, name: 'Black Abbott' },
        ...
        { id: 182, name: 'Cogliostro' },
        { id: 183, name: 'Colin Wagner' },
        { id: 184, name: 'Colossal Boy' },
        { id: 185, name: 'Colossus' },
        { id: 186, name: 'Copycat' },
        { id: 187, name: 'Corsair' },
        { id: 188, name: 'Cottonmouth' },
        { id: 189, name: 'Crimson Crusader' },
        { id: 190, name: 'Crimson Dynamo' },
        { id: 191, name: 'Crystal' },
        { id: 192, name: 'Curse' },
        { id: 193, name: 'Cy-Gor' },
        { id: 194, name: 'Cyborg' },
        ...
        { id: 249, name: 'Exodus' },
        { id: 250, name: 'Fabian Cortez' },
        { id: 251, name: 'Falcon' },
        { id: 252, name: 'Fallen One II' },
        { id: 253, name: 'Faora' },
        { id: 254, name: 'Feral' },
        { id: 255, name: 'Fighting Spirit' },
        ...
        { id: 281, name: 'Ghost Rider II' },
        { id: 282, name: 'Giant-Man' },
        { id: 283, name: 'Giant-Man II' },
        { id: 284, name: 'Giganta' },
        ...
        { id: 291, name: 'Goliath' },
        { id: 292, name: 'Goliath' },
        { id: 293, name: 'Goliath IV' },
        { id: 294, name: 'Gorilla Grodd' },
        { id: 295, name: 'Granny Goodness' },
        { id: 296, name: 'Gravity' },
        { id: 297, name: 'Greedo' },
        { id: 298, name: 'Green Arrow' },
        { id: 299, name: 'Green Goblin' },
        { id: 300, name: 'Green Goblin II' },
        { id: 301, name: 'Green Goblin III' },
        { id: 302, name: 'Green Goblin IV' },
        { id: 303, name: 'Groot' },
        { id: 304, name: 'Guardian' },
        ...
        { id: 316, name: 'Hawkman' },
        { id: 317, name: 'Hawkwoman' },
        { id: 318, name: 'Hawkwoman II' },
        { id: 319, name: 'Hawkwoman III' },
        { id: 320, name: 'Heat Wave' },
        { id: 321, name: 'Hela' },
        { id: 322, name: 'Hellboy' },
        { id: 323, name: 'Hellcat' },
        { id: 324, name: 'Hellstorm' },
        { id: 325, name: 'Hercules' },
        { id: 326, name: 'Hiro Nakamura' },
        { id: 327, name: 'Hit-Girl' },
        { id: 328, name: 'Hobgoblin' },
        { id: 329, name: 'Hollow' },
        { id: 330, name: 'Hope Summers' },
        { id: 331, name: 'Howard the Duck' },
        { id: 332, name: 'Hulk' },
        ...
        { id: 411, name: 'Liz Sherman' },
        { id: 412, name: 'Lizard' },
        { id: 413, name: 'Lobo' },
        { id: 414, name: 'Loki' },
        { id: 415, name: 'Longshot' },
        { id: 416, name: 'Luke Cage' },
        { id: 417, name: 'Luke Campbell' },
        ...
        { id: 552, name: 'Redeemer II' },
        { id: 553, name: 'Redeemer III' },
        { id: 554, name: 'Renata Soliz' },
        { id: 555, name: 'Rey' },
        { id: 556, name: 'Rhino' },
        ...
        { id: 621, name: 'Spider-Man' },
        { id: 622, name: 'Spider-Man' },
        { id: 623, name: 'Spider-Woman' },
        { id: 624, name: 'Spider-Woman II' },
        { id: 625, name: 'Spider-Woman III' },
        { id: 626, name: 'Spider-Woman IV' },
        { id: 627, name: 'Spock' },
        { id: 628, name: 'Spyke' },
        { id: 629, name: 'Stacy X' },
        ...
        { id: 662, name: 'Thunderbird II' },
        { id: 663, name: 'Thunderbird III' },
        ...
        { id: 671, name: 'Toxin' },
        { id: 672, name: 'Toxin' },
        { id: 673, name: 'Tracy Strauss' },
        { id: 674, name: 'Trickster' },
        { id: 675, name: 'Trigon' },
        ...
        { id: 682, name: 'Vagabond' },
        { id: 683, name: 'Valerie Hart' },
        ...
        { id: 691, name: 'Vertigo II' },
        { id: 692, name: 'Vibe' },
        { id: 693, name: 'Vindicator' },
        { id: 694, name: 'Vindicator' },
        { id: 695, name: 'Violator' },
        { id: 696, name: 'Violet Parr' },
        { id: 697, name: 'Vision' },
        { id: 698, name: 'Vision II' },
        { id: 699, name: 'Vixen' },
        { id: 700, name: 'Vulcan' },
        { id: 701, name: 'Vulture' },
        { id: 702, name: 'Walrus' },
        ...
        { id: 708, name: 'Wasp' },
        { id: 709, name: 'Watcher' },
        { id: 710, name: 'Weapon XI' },
        { id: 711, name: 'White Canary' },
        { id: 712, name: 'White Queen' },
